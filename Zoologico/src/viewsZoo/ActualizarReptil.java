 ...
 * @author Rey
 */
public class ActualizarReptil extends javax.swing.JFrame {

    /**
     * Creates new form AtualizarAve
     */
    public ActualizarReptil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Largo maximo");

        jLabel7.setText("Color de la piel");

        jLabel8.setText("Tiene patas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarReptil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarReptil().setVisible(true);
            }
        });
    }
